...
//get category from local json file
...
//getProductDetails from  local json file
...
/*export const getCurrency = () => {
  return async (dispatch, getState) => {
    try {
      ...
      console.log(currencyJson.data.currencies, "redux");
      console.log(localdata.data.currencies, "json");
